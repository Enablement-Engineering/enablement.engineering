...
1. **Perceive** the visual document through its original framework
2. **Understand** the semantic relationships and author intent
3. **Translate** into alternative frameworks (textual, sequential, relational)
4. **Preserve** meaning across the translation
